...
- _(optional) if you want to become a more productive R user, try learning some [`tidyverse`](https://www.tidyverse.org/)_ [^3]
:::

[^2]: Check out _"R for Data Science"_ [@wickham_r_2016, chapters 1-21]. The online version is free.
[^3]: _"Statistical inference via data science"_ [@ismay_statistical_2020, chapters 4-6] is another great free resource 
