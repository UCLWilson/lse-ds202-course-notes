...
## Syllabus (up to reading week) {.smaller}

| **Intro**                                                |         |
|----------------------------------------------------------|---------|
|      Introduction, Context & Key Concepts                | Week 01 |
| **Supervised Learning**                                  |         |
|      Simple and Multiple Linear Regression               | Week 02 |
|      Classifiers (Logistic Regression & Naive Bayes)     | Week 03 |
|      Resampling methods                                  | Week 04 |
|      Non-linear algorithms (Regression & Classification) | Week 05 |
| **Reading Week**                                         |         |
| _(break)_                                                | Week 06 |

## Syllabus (after reading week) {.scrollable .smaller}

| **Unsupervised Learning**                            |         |
|------------------------------------------------------|---------|
|      Principal Component Analysis (PCA) & Clustering | Week 07 |
|      Dimensionality Reduction (t-SNE & UMAP)         | Week 08 |
| **Applications**                                     |         |
|      Applications: Text as Data                      | Week 09 |
|      Applications: Topic Modelling                   | Week 10 |
|      Applications: Social Media Data                 | Week 11 |
...
-   *(optional) if you want to become a more productive R user, try learning some [`tidyverse`](https://www.tidyverse.org/)* [^3]
:::
